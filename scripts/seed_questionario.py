# scripts/seed_questionario.py

import sys
import os
from dotenv import load_dotenv

# Carrega as variáveis de ambiente do ficheiro .flaskenv na raiz do projeto
...
def popular_questionario():
    ...
    with app.app_context():
        ...
        if questionario_existente:
            print(f"O questionário '{titulo}' já existe na base de dados.")
            return

        print(f"A criar o questionário: '{titulo}'...")
        ...
        for pergunta_info in DADOS_QUESTIONARIO['perguntas']:
            ...
            if pergunta_info['tipo'] == 'texto_livre':
                opcao = OpcaoResposta(texto="Outro", pergunta_id=nova_pergunta.id)
